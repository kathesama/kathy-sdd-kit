...
- New code that duplicates an existing helper, component, utility, adapter, or
  project pattern
...
- Local symptom patches where the shared root cause is in a common caller,
  helper, or boundary already touched by the flow
